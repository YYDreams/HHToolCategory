...
///带边框与圆角的按钮
+ (instancetype)buttonwithFrame:(CGRect)frame title:(NSString *)title titleColor:(UIColor *)titleColor target:(id)target action:(SEL)action cornerRadius:(CGFloat)radius bgColor:(UIColor *)bgColor bordColor:(UIColor *)bordColor{
    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
    btn.frame = frame;
