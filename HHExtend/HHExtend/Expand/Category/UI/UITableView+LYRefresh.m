...
- (void)setupRefreshFunctionWith:(HHRefreshType)type
{
    ...
    {
        //集成头部刷新
        self.mj_header = [HHRefreshGifHeader headerWithRefreshingTarget:self refreshingAction:@selector(headerRefresh)];
//        self.mj_header = [HHRefreshFactory headerRefreshWithTarget:self refreshingAction:@selector(headerRefresh)];
    ...
    {
        //集成底部刷新
        self.mj_footer = [HHRefreshGitFooter footerWithRefreshingTarget:self refreshingAction:@selector(footerRefresh)];
